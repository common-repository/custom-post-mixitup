...
class nss_cpm_custom_post {
    ...
    public function register_nsscpm() {
        ...
        register_taxonomy('image_location', $this->cpt, array(
            'hierarchical' => true,
            'labels' => array(
                'name' => __('Model Image Cat', 'nsstheme'),
                'singular_name' => __('Model Image Cat', 'nsstheme'),
                'search_items' => __('Search Model Image Cat', 'nsstheme'),
                'popular_items' => __('Popular Model Image Cat', 'nsstheme'),
                'all_items' => __('All Model Image Cat', 'nsstheme'),
                'parent_item' => __('Parent Model Image Cat', 'nsstheme'),
                'parent_item_colon' => __('Parent Model Image Cat', 'nsstheme'),
                'edit_item' => __('Edit Model Image Cat', 'nsstheme'),
                'update_item' => __('Update Model Image Cat', 'nsstheme'),
                'add_new_item' => __('Add New Model Image Cat', 'nsstheme'),
                'new_item_name' => __('New Model Image Cat Name', 'nsstheme'),
                'add_or_remove_items' => __('Add or remove Model Image Cat', 'nsstheme'),
                'choose_from_most_used' => __('Choose from most used nsstheme', 'nsstheme'),
                'menu_name' => __('Model Image Cat', 'nsstheme'),
            ),
            'rewrite' => array(
                'slug' => 'image_location',
                'with_front' => false,
